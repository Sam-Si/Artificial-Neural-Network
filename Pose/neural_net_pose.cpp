...
int main()
{
    TrainingData trainData("all_train1.txt");
    ...
    while (!trainData.isEof()) 
    {
        ...
        if (trainingPass > 500 && myNet.getRecentAverageError() < 0.02)
        {
    ...
    while(epochs--){
        ...
        TrainingData trainData0("all_train.txt");
    ...
    TrainingData trainData1("all_test1.txt");
    ...
    cout << "Testing Data 2" << endl << endl;
        ...
        TrainingData trainData2("all_test2.txt");
